        ...
        if (separator != 0)
        {
            ...
            *separator = 0;
            ...
            if (tagfound)
            {
              ...
              BT_SERIAL.println(tagfound);
              BT_SERIAL.println("obstacle found!");
            ...
            if ((!tagfound) && (strcmp( separator, "rc 0 12 0 0" ) == 0))
             {
              Serial.println("No obstacle!"); 
              BT_SERIAL.println("No obstacle!"); 
            ...
            if ((!tagfound) && (strcmp( separator, "rc 0 0 0 0" ) == 0))
             {
              Serial.println("obstacle too large?!"); 
              BT_SERIAL.println("obstacle too large?!"); 
              //tello.sendCommand("rc 0 0 0 0");
              //controlmode = 0;
              //break;
